...
// SCENE
    ...
    #declare set_show_captions=1;                           // 0:no captions, 1 :captions
...
johnny(
    "Johnny",           // caption (name) of the actor
    ...
    array [9] {         // -- BODY MOVEMENT
        ...
        1.0,            // move arm left        -2.o/+2.0 relative motion of left arm,          e.g. 0.5
        1.0,            // move arm right       -2.o/+2.0 relative motion of right arm,         e.g. 0.5
    ...
    array [8] {         // -- BODY POSE         as offset to movement
        ...
        -20,            // pose arm left        start pose of left arm,  e.g. -20
        -20,            // pose arm right       start pose of right arm, e.g. -20
    ...
    array [5]{          // -- DRESS
        yellow_tex,     // head texture,       e.g. yellow_tex, flesh_tex, brown_tex
        yellow_tex,     // hands texture,
        blue_tex,       // pants texture,
        grey_tex,       // shirt texture,
        grey_tex        // shirt arms texture,
        },                   
    "shirt_print.gif",  // shirtprint file, empty string for no print
    array [4] {                
    ...
    array [4] {         // -- GEAR
        "headgear_01",  // headwear/hair        filename, empty string for bald
        "",             // neck/backwear        filename, e.g. neckgear_01
        "",             // hand tool left       filename, e.g. handgear_01
        "handgear_03"   // hand tool right      filename, e.g. handgear_01
        },                                  
    array [4]{          
