...
// Input file:   /Users/Irmo/Dropbox/SE3 Shared/7 WiSe 12/IVC/Gruppe Bornholdt-Frede-Timmann/blackhat.ldr
...
// Commandline:  "/Applications/IVC/L3P_Launcher_.9/L3P Launcher.app/Contents/Resources/l3p" "/Users/Irmo/Dropbox/SE3 Shared/7 WiSe 12/IVC/Gruppe Bornholdt-Frede-Timmann/blackhat.ldr" "/Users/Irmo/Dropbox/SE3 Shared/7 WiSe 12/IVC/Gruppe Bornholdt-Frede-Timmann/blackhat.pov" -o -lgeo -cg30,45,0
...
//// Model blackhat.ldr
#ifndef (blackhat_dot_ldr)
#declare blackhat_dot_ldr = object {
// untitled model
// Name:
// Author: Irmo
	// 1 75  150 -88 0  1 0 0  0 1 0  -0 0 1 61506.dat
	object {
		_61506_dot_dat
		matrix <1-L3SW/47,0,0,0,1-L3SW/24.72,0,0,0,1-L3SW/51,0,L3SW/-28.7442,L3SW/102>
		matrix <1,0,-0,0,1,0,0,0,1,150,-88,0>
		material { L3Color75 }
	}
}
#end // ifndef (blackhat_dot_ldr)


//// ModelData
#declare L3ModelBBoxMin = <126.5,-101.22,-25>;
#declare L3ModelBBoxMax = <173.5,-76.5,26>;
#declare L3ModelBBoxCenter = (L3ModelBBoxMin+L3ModelBBoxMax)/2; // <150,-88.86,0.5>
...
camera {
	...
	right    -L3AspectRatio*x
		...
		orthographic
		#declare L3LookAt = <150,-88.86,0.5>; // BBox center (not -cla)
		#declare L3OrthoScale = (1+L3PercentageBack/100.0)*56.0564;
		#declare L3Location = L3LookAt - 2000*<-0.612372,0.5,0.612372>;
		location L3Location
		scale    L3OrthoScale
	#else
		#declare L3LookAt = <153.635,-78.5429,-4.28927>; // Calculated (not -cla)
		#declare L3Location = <189.245,-107.619,-39.9002>;
...
//// Lights
light_source {
	<150,-129.98,-40.6199>  // Latitude,Longitude,Radius: 45,0,58.1524
	color rgb <1,1,1>
}
light_source {
	<193.614,-117.936,25.6807>  // Latitude,Longitude,Radius: 30,120,58.1524
	color rgb <1,1,1>
}
light_source {
	<124.819,-139.221,15.0381>  // Latitude,Longitude,Radius: 60,-120,58.1524
	color rgb <1,1,1>
}

//// ModelObject blackhat.ldr
object { blackhat_dot_ldr }
