...
// Date:         Mon Dec 17 15:59:14 2012
// Input file:   /Users/Irmo/Dropbox/SE3 Shared/7 WiSe 12/IVC/Gruppe Bornholdt-Frede-Timmann/Objekte/fedora.ldr
...
// Commandline:  "/Applications/IVC/L3P_Launcher_.9/L3P Launcher.app/Contents/Resources/l3p" "/Users/Irmo/Dropbox/SE3 Shared/7 WiSe 12/IVC/Gruppe Bornholdt-Frede-Timmann/Objekte/fedora.ldr" "/Users/Irmo/Dropbox/SE3 Shared/7 WiSe 12/IVC/Gruppe Bornholdt-Frede-Timmann/Objekte/fedora.pov" -o -cg30,45,0
...
//// Model fedora.ldr
#ifndef (fedora_dot_ldr)
#declare fedora_dot_ldr = object {
// untitled model
// Name:
// Author: Irmo
	// 1 70  0 0 0  1 0 0  0 1 0  -0 0 1 61506.dat
	object {
		_61506_dot_dat
...
#end // ifndef (fedora_dot_ldr)


//// ModelData
#declare L3ModelBBoxMin = <-23.5,-13.22,-25>;
#declare L3ModelBBoxMax = <23.5,11.5,26>;
#declare L3ModelBBoxCenter = (L3ModelBBoxMin+L3ModelBBoxMax)/2; // <0,-0.86,0.5>
...
camera {
	...
	right    -L3AspectRatio*x
		...
		orthographic
		#declare L3LookAt = <0,-0.86,0.5>; // BBox center (not -cla)
		#declare L3OrthoScale = (1+L3PercentageBack/100.0)*56.0564;
		#declare L3Location = L3LookAt - 2000*<-0.612372,0.5,0.612372>;
		location L3Location
		scale    L3OrthoScale
	#else
		#declare L3LookAt = <3.63457,9.45707,-4.28928>; // Calculated (not -cla)
		#declare L3Location = <39.2455,-19.6191,-39.9002>;
...
//// Lights
light_source {
	<0,-41.9799,-40.6199>  // Latitude,Longitude,Radius: 45,0,58.1523
	color rgb <1,1,1>
}
light_source {
	<43.6143,-29.9362,25.6807>  // Latitude,Longitude,Radius: 30,120,58.1523
	color rgb <1,1,1>
}
light_source {
	<-25.1807,-51.2214,15.0381>  // Latitude,Longitude,Radius: 60,-120,58.1523
	color rgb <1,1,1>
}

//// ModelObject fedora.ldr
object { fedora_dot_ldr }
